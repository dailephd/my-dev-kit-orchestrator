...
```bash
npx @dailephd/my-dev-kit-orchestrator@1.3.3 init
npx @dailephd/my-dev-kit-orchestrator@1.3.3 start "Add audit logging"
npx @dailephd/my-dev-kit-orchestrator@1.3.3 prompt
```
...
```bash
npx @dailephd/my-dev-kit-orchestrator@1.3.3 status
npx @dailephd/my-dev-kit-orchestrator@1.3.3 check --all
```
...
`npx` examples above are pinned to `1.3.3`.
