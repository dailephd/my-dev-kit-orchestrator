...
## v1.1.0 implementation-readiness checklist

This section verifies the Greenfield Bootstrap Foundation before a separate
pre-release workflow. It does not record publication, security validation, or
release completion.
...
### Greenfield temporary-directory smoke

- [ ] initialize a dedicated directory outside the repository with `init`
...
- [ ] seven modes are documented and `greenfield` is the seventh
- [ ] all 13 greenfield stages and implemented artifact paths are documented
