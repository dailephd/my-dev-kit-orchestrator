...
describe('documentation consistency gate', () => {
  ...
  it.each([
    ...
    ['contradictory v1.2.2 unreleased status', 'README.md', (text: string) => `${text}\nv1.2.2 is unreleased.\n`, 'V122_RELEASE_STATUS_CONTRADICTION'],
    ['missing v1.2.2 publication', 'README.md', (text: string) => replace(text, '@dailephd/my-dev-kit-orchestrator@1.2.2', '@dailephd/my-dev-kit-orchestrator@1.1.0'), 'V122_PUBLISHED_CLAIM_MISSING'],
